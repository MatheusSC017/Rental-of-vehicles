    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rental_relationship', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='additional_items_rental', to='rental.rental', verbose_name='Aluguel')),
            ],
            options={
